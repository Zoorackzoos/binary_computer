from src.finished.decimal_to_binary.thirty_two_bit.thirty_two_bit_unsigned_decimal_to_binary_array import \
    thirty_two_bit_unsigned_decimal_to_binary_array_no_print_statements
...
if __name__ == "__main__":
    ...
    print(thirty_two_bit_unsigned_decimal_to_binary_array_no_print_statements(decimal=four_shifted_bitmask_of_exponent_field))
