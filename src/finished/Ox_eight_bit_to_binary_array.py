from src.finished.A_universal_functions.eight_bit.eight_bit_unsigned_decimal_to_binary_array import eight_bit_unsigned_decimal_to_binary_array_no_print_statements,eight_bit_unsigned_decimal_to_binary_array
...
def Ox_eight_bit_to_binary_array(Ox, tab_amount="\t"):
    ...
    return_array = eight_bit_unsigned_decimal_to_binary_array_no_print_statements(Ox_decimal, tab_amount=tab_amount)
