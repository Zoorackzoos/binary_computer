...
from src.decimal_to_binary.eight_bit_decimal_to_binary_array import eight_bit_decimal_to_binary_array_no_print_statements, eight_bit_decimal_to_binary_array

def intro_exponentiate():
    print("binary difference between a number and a number at a exponent")
    print(eight_bit_decimal_to_binary_array_no_print_statements(math.pow(2, 0)))
    print(eight_bit_decimal_to_binary_array_no_print_statements(math.pow(2, 1)))
    print(eight_bit_decimal_to_binary_array_no_print_statements(math.pow(2, 2)))
